...
class Debby
{
    ...
    function __construct($dbpath = "", $username = "", $password = "", $dbtype = "sqlite", $outputdateformat = "YYYY-mm-dd", $tag = "DEB", $debug = false)
    { //possible options are dd/mm/YYYY dd-mm-YYYY dd.mm.YYYY mm/dd/YYYY ... YYYY-mm-dd etc ...
        if (!empty($dbpath)) {
            $this->debug = $debug;
            $this->tag = $tag;
    ...
    function connect($dbpath = "", $username = "", $password = "", $dbtype = "sqlite", $outputdateformat = "YYYY-mm-dd h:i:s")
    {
        ...
        } else /* MSSQL srv native components */
...
Ruth::setOBJECT("' . Ruth::getREQUEST("txtALIAS") . '", $' . Ruth::getREQUEST("txtALIAS") . ');';
    ...
    function getRows($sql = "", $rowtype = 0, $fetchblob = true, $calculatedfields = array())
    {
        ...
        } else /* Microsoft SQL Server Native Drivers */
            if ($this->dbtype == "mssqlnative") {
            ...
            if ($this->dbtype == "odbc") {
                ...
                if ($this->dbtype == "mssqlnative") {
                    ...
                    if ($this->dbtype == "CUBRID") {
                        ...
                        if ($this->dbtype == "sqlite" || $this->dbtype == "sqlite3") {
    ...
    */
    ...
    function generateCsv($sql, $filename = "temp.csv", $delim = ",")
    {
        ...
        if (!empty($results)) {
            ...
            fputcsv($fh, array_map(function ($element) {
                return $element['alias'];
            }, $this->fieldinfo), $delim);
