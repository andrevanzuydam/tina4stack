...
$<$form$>$ $<$input type=\char`\"{}text\char`\"{} name=\char`\"{}txt\+N\+A\+M\+E\char`\"{} value=\char`\"{}\+Andre\char`\"{}$>$ $<$input type=\char`\"{}text\char`\"{} name=\char`\"{}txt\+D\+A\+T\+E\char`\"{} value=\char`\"{}01/10/2010\char`\"{}$>$ $<$/form$>$ \hypertarget{classDebby_aafffcf8afae3d308853f4452cd09babe}{}\index{Debby@{Debby}!insert@{insert}}
